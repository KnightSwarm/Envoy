...
class UserSetting extends CPHPDatabaseRecordClass
{
	public $table_name = "user_settings";
	public $fill_query = "SELECT * FROM user_settings WHERE `Id` = :Id";
	public $verify_query = "SELECT * FROM user_settings WHERE `Id` = :Id";
